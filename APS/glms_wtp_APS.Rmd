...
setwd('/Users/melziur/Desktop/scoring_wtp/ALL_WTP_MASTER.csv')
...
glm10<-glmer(exp_chosen~nonsocial_money+social_money*AQ_MC+social_money*MSPSS_MC+(1|subid), data=new_WTPdata, family = binomial(link = "logit"),control=glmerControl(optimizer="bobyqa"))
```

```{r}

old_WTPdata<-read.csv(file='UNBALANCED_wtp_LONG.csv',header = TRUE,sep = ',')
```
